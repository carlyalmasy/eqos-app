...
export default function CredentialsGrid({ data }) {
        ...
        <Grid split="3" className="auto-rows">
          <div className="container rounded-lg bg-white drop-shadow-md z-0">
            <div className="grid grid-cols-12 grid-rows-1">
              <div className="col-span-6 p-6">
                <div className="text-center relative mb-6">
                  ...
                  <div className="absolute top-2/4 left-2/4 -translate-x-2/4 translate-y-1/4">
                    ...
                    <p className="mt-0 leading-tight text-xs">
                      Overall Quality
                    </p>
                  </div>
                </div>
                  ...
                  {Object.keys(data?.scores?.details).map((header, i) => (
                    <React.Fragment key={i}>
                      ...
                      <div className="border border-neutrals-light-500 w-[100%]">
                        <div
                          className={bjoin(
                            'bg-' + overallRating + '-300 h-[2px] w-[' + Math.round((data?.scores?.details[header] / 5) * 100) + '%]'
                          )}
                        ></div>
                      </div>
                    </React.Fragment>
              ...
              <div
                className={bjoin(
                  "col-span-6 col-start-7 bg-" + overallRating + "-100 p-6"
                )}
              >
